...
namespace FIMSpace.FEditor
{
    public static class FGUI_Inspector
    {
        ...
        public static void FoldHeaderStart(ref bool foldout, string title, GUIStyle style, Texture icon = null, int height = 22)
        {
            ...
            if (GUILayout.Button(new GUIContent("  " + FGUI_Resources.GetFoldSimbol(foldout, 10, "►") + "  " + title, icon), FGUI_Resources.FoldStyle, GUILayout.Height(height))) foldout = !foldout;
        }
        ...
        public static void DrawWarning(string title)
        {
